...
public class Human extends StdRace
{
	...
	private String[]culturalAbilityNames={"Skill_Write", "Distilling", "Skill_Swim"};
	...
	public int availabilityCode(){return Area.THEME_TECHNOLOGY;}
	...
	{
		double pct=(CMath.div(mob.charStats().getPoints(CharStats.STAT_HITPOINTS),mob.charStats().getMaxPoints(CharStats.STAT_HITPOINTS)));
