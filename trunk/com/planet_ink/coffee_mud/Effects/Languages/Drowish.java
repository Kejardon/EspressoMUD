...
public class Drowish extends StdLanguage
{
	...
	@Override public Vector<String[]> translationVector(String language)
	{
		if(wordLists==null)
		{
			...
			String[] three={"�na","cil","sar","tan","hel","loa","si'r","hep","yur","nol","hol","qua","�th"};
			String[] four={"s�ya","qual","quel","lara","uqua","sana","yava","mas'se","yan'na","quettaparma","manna","manan","merme","carma","harno","harne","varno","essar","saira","cilta","veuma","norta","turme","saita"};
			String[] five={"cuiva","cuina","nonwa","imire","nauta","cilta","entuc","norta","latin","l�tea","veuya","veuro","apama","hampa","nurta","firta","saira","holle","herwa","uquen","arcoa","calte","cemma","hanta","tan'en"};
			String[] six={"mahtale","porisal'que","hairie","tararan","amba'rwa","lati'na","ol�tie","amawil","apacen","yavinqua","apalume","lin'quil'ea","menelwa","alassea","nurmea","parmasse","ceniril","heldasse","imirin","eari'na","calaten'gew","lapselunga","ria'nna","eneques"};
