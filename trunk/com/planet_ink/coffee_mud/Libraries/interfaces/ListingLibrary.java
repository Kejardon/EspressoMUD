...
public interface ListingLibrary extends CMLibrary
{
	...
	public int getReps(Interactable item, Vector theRest, MOB mob, boolean useName, boolean longLook);
	public void appendReps(int reps, StringBuilder say);
	public StringBuilder lister(MOB mob, Vector things, boolean useName, String tag, String tagParm, boolean longLook);
