...
public interface RawMaterial extends Item
{
	...
	public enum Resource
	{
		...
		STONE(Material.ROCK,1,80,5,2500, "mild musty", new Phases(1000, 1500), ThermalReaction.None), //Melt, boil
		LIMESTONE(Material.ROCK,1,20,4,1550, Phases.OnlySolid, ThermalReaction.ToQuickLime),
		FLINT(Material.ROCK,1,10,4,2600, new Phases(1900, 2500), ThermalReaction.ToSilica), //Melt, boil (Change to Silica?)
		GRANITE(Material.ROCK,2,10,6,2690, new Phases(1500, 2200), ThermalReaction.ToSilica), //Melt, boil (Change to Silica?)
		OBSIDIAN(Material.ROCK,10,5,6,2650, new Phases(1900, 2500), ThermalReaction.ToSilica), //Melt, boil (Change to Silica?)
		MARBLE(Material.ROCK,20,5,5,2560, Phases.OnlySolid, ThermalReaction.ToQuickLime), //Burn to quick lime
		SAND(Material.ROCK,1,50,1,1600, new Phases(1900, 2500), ThermalReaction.ToSilica), //Melt, boil (Change to Silica?)
		JADE(Material.PRECIOUS,50,2,5,3800, new Phases(1500, 2000), ThermalReaction.None), //Melt, boil (Largely guessing on this)
		IRON(Material.METAL,20,10,6,7900, new Phases(1800, 3000), ThermalReaction.None), //Melt, boil
		LEAD(Material.METAL,10,10,5,11300, new Phases(600, 2000), ThermalReaction.None), //Melt, boil
		BRONZE(Material.METAL,10,10,5,8100, new Phases(1200, 2850), ThermalReaction.None), //Melt, boil
		SILVER(Material.METAL,30,2,5,10500, new Phases(1230, 2440), ThermalReaction.None), //Melt, boil
		GOLD(Material.METAL,150,1,5,19320, new Phases(1340, 3130), ThermalReaction.None), //Melt, boil
		ZINC(Material.METAL,10,5,5,7100, new Phases(690, 1180), ThermalReaction.None), //Melt, boil
		COPPER(Material.METAL,10,10,5,8900, new Phases(1360, 2830), ThermalReaction.None), //Melt, boil
		TIN(Material.METAL,10,10,4,7300, new Phases(500, 2870), ThermalReaction.None), //Melt, boil
		MITHRIL(Material.MITHRIL,100,1,9,3990, new Phases(2000, 3800), ThermalReaction.None), //Melt, boil
		ADAMANTITE(Material.MITHRIL,175,1,10,4500, new Phases(2500, 4000), ThermalReaction.None), //Melt, boil
		STEEL(Material.METAL,75,0,8,7840, new Phases(1550, 3200), ThermalReaction.None), //Melt, boil
		BRASS(Material.METAL,120,0,6,8500, new Phases(1200, 2700), ThermalReaction.None), //Melt, boil
		...
		WATER(Material.LIQUID,0,100,0,1000, new Phases(273, 373), ThermalReaction.None), //Melt, boil
		SALTWATER(Material.LIQUID,0,100,0,1030, new Phases(263, 376), ThermalReaction.None), //Melt, boil
		//LIQUID(Material.LIQUID,0,1,0,1000),
		GLASS(Material.GLASS,10,0,3,2800, new Phases(2000, 2500), ThermalReaction.None), //Melt, boil (Change to Silica?)
		PAPER(Material.PAPER,10,0,0,92, Phases.OnlySolid, ThermalReaction.WoodBurn), //Burn to ash/charcoal
		CLAY(Material.GLASS,1,50,1,1750, "mild dusty", Phases.OnlySolid, new ThermalReaction(1500, 0, new ThermalReaction.TRResult(1000, "CHINA"))), //Change to China
		CHINA(Material.GLASS,30,0,3,2400, new Phases(2000, 2500), ThermalReaction.None), //Melt, boil
		DIAMOND(Material.PRECIOUS,500,1,9,3510, Phases.OnlySolid, new ThermalReaction(1000)), //Burn and evaporate
		...
		PLATINUM(Material.METAL,150,1,6,21450, new Phases(2040, 4100), ThermalReaction.None), //Melt, boil
		MILK(Material.LIQUID,2,10,0,1020, "mild milky", new Phases(270, 374), ThermalReaction.None), //Melt, boil
		...
		COFFEE(Material.LIQUID,0,10,0,430, "rich coffee", new Phases(270, 374), ThermalReaction.None), //Melt, boil
		OPAL(Material.PRECIOUS,80,2,5,2250, new Phases(1900, 2500), ThermalReaction.ToSilica.scaleResult(900)), //Melt, boil. Change to Silica and lose 10% mass
		TOPAZ(Material.PRECIOUS,200,2,5,3570, Phases.OnlySolid, 
				new ThermalReaction(1300, 0,
		...
		AMETHYST(Material.PRECIOUS,300,2,5,2651, new Phases(1900, 2500), ThermalReaction.ToSilica), //Melt, boil. Change to Silica
		GARNET(Material.PRECIOUS,70,2,5,3870, Phases.OnlySolid, ThermalReaction.None), //I can't find any info
		AMBER(Material.PRECIOUS,80,5,5,2500, Phases.OnlySolid, new ThermalReaction(650, ThermalReaction.SlowBurn)), //Burns slowly to ?
		...
		BLOOD(Material.LIQUID,1,100,0,102, "strong salty", new Phases(270, 374), ThermalReaction.None), //Melt, boil
		BONE(Material.ROCK,1,100,5,160, Phases.OnlySolid, new ThermalReaction(1300, 0)), //Half dries out/evaporates, half changes to Hydroxylapatite. TODO
		COAL(Material.ROCK,1,50,1,180, "chalky", Phases.OnlySolid, new ThermalReaction(850, new ThermalReaction.TRResult(10, "ASH"))), //Burns, tiny bit of ash remains (1%?)
		LAMPOIL(Material.LIQUID,"LAMP OIL",1,10,1,88, "light oily", new Phases(270, 570), new ThermalReaction(570)), //Burns, no real remains
		//POISON(Material.LIQUID,1,1,1,100), //uh
		LIQUOR(Material.LIQUID,10,1,1,79, "alcohol", new Phases(159, 352), new ThermalReaction(635)), //Ethanol. Burns as a gas
		SUGAR(Material.VEGETATION,1,50,1,1600, Phases.OnlySolid, new ThermalReaction(460, 0, new ThermalReaction.TRResult(1000, "CARAMEL"))), //Decomposes to caramel liquid
		HONEY(Material.LIQUID,1,50,1,1600, new Phases(265, Integer.MAX_VALUE), new ThermalReaction(330, 0, new ThermalReaction.TRResult(1000, "CARAMEL"))), //Melts, then decomposes to caramel
		CARAMEL(Material.LIQUID,1,0,1,1600, new Phases(265, 800), ThermalReaction.None), //Pure guess on phases.
		...
		IVORY(Material.ROCK,5,5,3,1840, Phases.OnlySolid, new ThermalReaction(1000,0, new ThermalReaction.TRResult(1000,"LIMESTONE"))), //Dries out to calcium carbonate then burn to quicklime
		WAX(Material.FLESH,1,0,0,900, new Phases(340, 400), new ThermalReaction(380,ThermalReaction.SlowBurn)), //Burn slowly to nothing
		...
		ONYX(Material.PRECIOUS,70,1,8,2650, new Phases(1900, 2500), ThermalReaction.ToSilica),
		/*
		...
		*/
		QUARTZ(Material.PRECIOUS,25,1,5,2650, new Phases(2020, 2700), ThermalReaction.None), //Guessing
		...
		QUICKLIME(Material.ROCK,8,0,2,3350, new Phases(2845, 3123), ThermalReaction.None), //Reacts with water. TODO
		MULLITE(Material.ROCK,100,0,6,3200, new Phases(2100, 2700), ThermalReaction.None), //Entirely guessing on a lot of this
		;
	...
	public static class ThermalReaction
	{
		...
		public final static ThermalReaction WoodBurn = new ThermalReaction(620, new TRResult(10, "ASH"));
		public final static ThermalReaction MeatBurn = new ThermalReaction(1030, ThermalReaction.SlowBurn, new TRResult(10, "ASH"));
		public final static ThermalReaction ToQuickLime = new ThermalReaction(1100, 0, new TRResult(453, "QUICKLIME")); //Calculated for CaCO3
		public final static ThermalReaction ToSilica = new ThermalReaction(1900, 0, new TRResult(1000, "QUARTZ"));
	}
