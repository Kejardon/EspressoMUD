...
public class Possess extends StdCommand
{
	...
	public MOB getTarget(MOB mob, Vector commands, boolean quiet)
	{
		...
		if((target==null)||((!CMLib.flags().canBeSeenBy(target,mob))&&((!CMLib.flags().canBeHeardBy(target,mob)))))
		{
			if(!quiet)
			{
		...
		throws java.io.IOException
	{
		...
		target.tell("^HYour spirit has changed bodies"
						+(CMath.bset(mob.playerStats().getBitmap(),PlayerStats.ATT_SYSOPMSGS)?" and SECURITY mode is ON":"")
