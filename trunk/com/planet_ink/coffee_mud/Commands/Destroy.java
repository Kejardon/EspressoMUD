...
public class Destroy extends StdCommand
{
	...
	public boolean items(MOB mob, Vector commands)
	{
		...
		while(deadItem!=null)
		{
			...
			deadItem.destroy();
			mob.location().removeItem(deadItem);
			deadItem=null;
			...
			else
			{
				...
				else
				{
					...
					mob.tell(
						...
						+"EXIT, ITEM, AREA, USER, MOB, SESSION, TICKS, THREAD, SOCIAL, CLASS, ABILITY, COMPONENT, RACE, TITLE, BAN, NOPURGE, BUG, TYPO, IDEA, or a ROOM.");
				}
			}
		}
		return false;
