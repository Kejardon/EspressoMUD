...
public class Poof extends StdCommand
{
		...
		throws java.io.IOException
	{
		...
		{
			int showNumber=0;
			String poofIn=CMLib.genEd().stringPrompt(mob,mob.playerStats().poofIn());
			String poofOut=CMLib.genEd().stringPrompt(mob,mob.playerStats().poofOut());
			String tranPoofIn=CMLib.genEd().stringPrompt(mob,mob.playerStats().tranPoofIn());
			String tranPoofOut=CMLib.genEd().stringPrompt(mob,mob.playerStats().tranPoofOut());
