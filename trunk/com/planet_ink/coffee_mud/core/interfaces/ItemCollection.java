...
public interface ItemCollection extends CMObject, CMModifiable, CMSavable//, ListenHolder
{
	...
	public static class DefaultItemCol implements ItemCollection, Ownable
	{
		public static ItemCollection getFrom(CMObject O)
		{
			if(O instanceof DefaultItemCol) return (DefaultItemCol)O;
		...
		public DefaultItemCol(CMObject O){parent=O;}
		...
		public boolean hasItem(Item item, boolean sub)
		{
			...
			for(int i=inventory.size()-1;i>=0;i--)
			{
				...
				ItemCollection O=getFrom(inventory.get(i));
